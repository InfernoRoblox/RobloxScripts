...
appendfile("Version.txt", "v.1.0.0a")

-- Starting GUI
local Window = Library.CreateLib("Falamen", "Sentinel")

--Local Section
local LocalPlayer = Window:NewTab("Local Player")
local LocalSection Main:NewSecion("Local Player")

LocalSection:NewSlider("SpeedHax", "Makes your speed go da flash", 500, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 16
end)

LocalSection:NewSlider("SpeedHax", "Makes your Jump power weeeeeeeeeeeee", 500, 0, function(s) -- 500 (MaxValue) | 0 (MinValue)
    game.Players.LocalPlayer.Character.Humanoid.JumpPower = 50
end)

--ScriptHub
local ScriptHub = Window:NewTab("Script Hub")
local ScriptHubSection Main:NewSection(" Script Hub")

Section:NewButton("Infinite Yield", "Executes Infinite Yield using Falamen Script Hub", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source"))()
end)

-- Others
local NotRelated = Window:NewTab("Others")
local NotRelatedSection = Window:NewTab("Others")

Section:NewButton("Discord Server", "Joins Discord", function()
    clipboard("We Have No Discord Server")
end)

local Credits = Window:NewTab("Credits")

Section:NewLabel("Owner: Jose Mari Chan#5288")
